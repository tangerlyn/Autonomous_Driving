...
class PurePursuit : public rclcpp::Node {
   ...
   private:
    ...
    void publish_message(double steering_angle, double speed); // for pid controller
    double get_curvature(); // for pid controller
    void adjust_pid_by_curvature(double curvature);
