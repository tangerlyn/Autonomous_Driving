...
public:
	...
	// Load trajectory
	std::string package_share_directory = ament_index_cpp::get_package_share_directory("mpc");
	std::string traj_path = package_share_directory + "/racelines/traj_full.csv";
	trajectory_ = loadTrajectoryFromCSV(traj_path);
